...
import com.creativeperson.cheddar.views.RefreshableListView.OnHeaderViewChangedListener;
...
public class ListHeaderView extends ViewGroup {
	...
	private class CloseTimer extends CountDownTimer {
		...
		public void onTick(long millisUntilFinished) {
			final int interval = (int) (AnimationUtils.currentAnimationTimeMillis() - mStart);
